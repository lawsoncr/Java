...
public class DoubleArraySeq implements Cloneable
{
    ...
    public void addAfter(double element) throws OutOfMemoryError
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    System.arraycopy(data, currentIndex, data, currentIndex + 1, size());
                    currentIndex++;
                    data[currentIndex] = element;
                }
                else
    ...
    public void ensureCapacity(int minimumCapacity) throws OutOfMemoryError
    {
        ...
        {
            maxArray = new double[minimumCapacity];
            System.arraycopy(data, 0, maxArray, 0, manyItems);
            data = maxArray;
        }
    }
    ...
    public void removeCurrent() throws IllegalStateException
    {
        ...
        else
        {
            ...
            {
                System.arraycopy(data, currentIndex + 1, data, currentIndex, getCapacity() - currentIndex - 1);
                manyItems--;
            }
        }
    }
    ...
    public void trimToSize() throws OutOfMemoryError
    {
        ...
        {
            trimArray = new double[manyItems];
    ...
    public boolean equals(Object other)
    {
        ...
        result = (currentIndex == ((DoubleArraySeq) other).currentIndex);
